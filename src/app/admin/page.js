      ...
      <div className="min-h-screen bg-[#120CD6] text-white flex items-center justify-center p-4 select-none font-sans selection:bg-[#E5FD5F] selection:text-[#111111]">
        <div className="w-full max-w-md p-8 md:p-10 bg-white text-[#111111] rounded-3xl shadow-2xl flex flex-col items-center gap-6 border-4 border-white">
          ...
          <div className="flex items-center gap-2 px-4 py-1.5 bg-[#120CD6] text-[#E5FD5F] rounded-full text-xs font-black uppercase tracking-wider">
            <span className="w-2 h-2 rounded-full bg-[#E5FD5F] animate-ping" />
            ✳ NADHISAN STUDIO CLOUD
          </div>

          <div className="text-center space-y-1">
            <div className="w-12 h-12 rounded-2xl bg-[#E5FD5F] text-[#111111] border-2 border-[#120CD6] flex items-center justify-center mx-auto mb-2 font-black shadow-md">
          ...
          {/* Login Method Toggle */}
          <div className="grid grid-cols-2 gap-1 p-1 bg-slate-100 rounded-2xl w-full border-2 border-slate-200">
            <button
              type="button"
              ...
              className={`py-2 text-xs font-black uppercase tracking-wider rounded-xl transition-all cursor-pointer ${
                loginMethod === 'credentials'
                  ? 'bg-[#120CD6] text-white shadow-sm'
          ...
          {authError && (
            <div className="w-full p-3.5 bg-rose-50 border-2 border-rose-500 text-rose-700 rounded-2xl text-xs font-bold flex items-center gap-2">
          ...
          {loginMethod === 'credentials' ? (
            <form onSubmit={handleCredentialLogin} className="w-full space-y-4">
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-3.5 py-3 bg-slate-50 border-2 border-slate-200 rounded-2xl text-sm font-bold text-slate-900 placeholder:text-slate-400 focus:outline-none focus:border-[#120CD6] transition-colors"
                  />
                </div>
              </div>
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="••••••••••••"
                    className="w-full pl-10 pr-10 py-3 bg-slate-50 border-2 border-slate-200 rounded-2xl text-sm font-bold text-slate-900 placeholder:text-slate-400 focus:outline-none focus:border-[#120CD6] transition-colors"
                  />
                  <button
                    type="button"
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-3.5 bg-[#E5FD5F] hover:bg-[#d8f244] active:bg-[#F908E0] active:text-white text-[#111111] border-2 border-[#120CD6] font-black rounded-2xl text-xs uppercase tracking-wider transition-all shadow-md cursor-pointer disabled:opacity-50 flex items-center justify-center gap-2 hover:scale-[1.02]"
              >
                {loading ? (
                  <>
            ...
            <form onSubmit={handlePinLogin} className="w-full space-y-4">
              <div className="space-y-1.5">
                <label className="text-[11px] font-black uppercase tracking-wider text-slate-700 block text-center">
                ...
                <input
                  ...
                  placeholder="••••"
                  className="w-full text-center tracking-widest text-3xl font-mono py-3.5 bg-slate-50 border-2 border-slate-200 rounded-2xl text-slate-900 focus:outline-none focus:border-[#120CD6] transition-colors"
                  autoFocus
                />
              </div>
          ...
          <p className="text-[11px] text-slate-500 text-center font-bold">
            SANS Design • Nadhisan Studio Cloud OS
          </p>
        </div>
      </div>
    );
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <header className="h-16 bg-white border-b-2 border-slate-200 px-4 md:px-8 flex items-center justify-between sticky top-0 z-30">
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2 text-xs md:text-sm">
              <span className="text-slate-400 font-bold uppercase tracking-wider">Studio Hub</span>
              <span className="text-slate-300 font-black">/</span>
              <h1 className="text-base md:text-lg font-black text-[#120CD6] tracking-tight uppercase">
                {activeItemLabel}
              </h1>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="px-3.5 py-1.5 bg-slate-100 text-slate-800 rounded-full border border-slate-200 text-xs font-bold">
              {currentDateIndo}
            </span>
          </div>
        </header>
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                ...
                <div className="bg-white rounded-2xl p-5 border border-slate-200 flex items-center justify-between">
                  ...
                  <div className="w-12 h-12 rounded-2xl bg-indigo-50 text-indigo-700 font-bold border border-indigo-200 border-2 border-[#120CD6] flex items-center justify-center shrink-0 shadow-xs">
                        ...
                        >
                          ...
                          <div className="flex items-center gap-2 shrink-0">
                            <button
                              ...
                              className="px-4 py-2 bg-[#120CD6] hover:bg-blue-800 active:bg-[#F908E0] text-white rounded-xl text-xs font-black transition-colors cursor-pointer uppercase shadow-xs flex items-center gap-1.5"
                    ...
                    {sessions && sessions.length > 0 ? (
                      sessions.slice(0, 4).map((s, idx) => (
                        <div key={s.sessionId || idx} className="flex items-start gap-3">
                          <div className="w-8 h-8 rounded-full bg-indigo-50 text-indigo-700 font-bold border border-indigo-200 border border-[#120CD6] flex items-center justify-center shrink-0 font-bold">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    className="px-4 py-2 bg-[#120CD6] hover:bg-blue-800 active:bg-[#F908E0] text-white shadow-md shadow-sm flex items-center gap-1.5 transition-colors cursor-pointer uppercase"
                  >
          ...
          {activeTab === 'live_monitor' && (
            <div className="space-y-6">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-2">
                  <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-indigo-50 text-indigo-700 border-2 border-[#120CD6] text-[#111111] text-xs font-black">
                              ...
                              <button
                                ...
                                className={`px-3 py-1.5 rounded-xl text-xs font-black transition-colors flex items-center gap-1.5 cursor-pointer uppercase ${
                                  k.is_event_mode
                                    ...
                                    : "bg-indigo-50 text-indigo-700 font-bold border border-indigo-200 border border-[#120CD6]"
                                }`}
                              >
                                <Sliders className="w-3.5 h-3.5" />
                          ...
                          <div className="flex items-center justify-between text-xs">
                            ...
                            <div className="flex items-center gap-1.5">
                              <button
                                ...
                                disabled={actionLoading}
                                className="px-3 py-1 bg-[#120CD6] text-white rounded-lg text-xs font-black hover:bg-indigo-700 cursor-pointer uppercase"
                              >
                                Panggil
                              </button>
                              <button
            ...
            <div className="space-y-6">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                ...
                <button
                  ...
                  className="px-4 py-2.5 bg-[#120CD6] hover:bg-blue-800 active:bg-[#F908E0] text-white rounded-xl text-xs font-black flex items-center gap-1.5 transition-colors cursor-pointer uppercase"
                >
                            ...
                            <div className="flex flex-col items-center justify-center gap-2">
                              ...
                              <div className="flex items-center gap-2 mt-2">
                                ...
                                <button
                                  ...
                                  className="px-4 py-2 bg-[#120CD6] text-white rounded-xl text-xs font-bold cursor-pointer hover:bg-indigo-700 transition shadow"
                                >
                                  + Tambah Kiosk Baru
                                </button>
                              </div>
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                  ...
                  <div className="flex items-center gap-2">
                    <button
                      ...
                      className="px-4 py-2.5 bg-[#E5FD5F] hover:bg-[#d8f244] active:bg-[#F908E0] active:text-white text-[#111111] border-2 border-[#120CD6] text-white font-black rounded-xl text-xs flex items-center gap-2 shadow-md shadow-sm transition-all cursor-pointer uppercase tracking-tight"
                    >
                ...
                <div className="bg-white rounded-2xl border border-slate-200 p-5 md:p-6 space-y-4">
                  ...
                  <form onSubmit={handleSaveVoucher} className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-3 text-xs">
                    ...
                    <div className="flex items-end">
                      <button
                        type="submit"
                        className="w-full py-2 bg-[#120CD6] hover:bg-blue-800 active:bg-[#F908E0] text-white font-black rounded-xl text-xs transition-colors cursor-pointer uppercase"
                      >
                        + Simpan
                      </button>
                    </div>
                                ...
                                <td className="py-3.5 px-4">
                                  <button
                                    ...
                                    className={`px-2.5 py-0.5 rounded-full text-[11px] font-black cursor-pointer transition-colors ${
                                      v.active !== false ? 'bg-indigo-50 text-indigo-700 font-bold border border-indigo-200 border border-[#120CD6]' : 'bg-slate-100 text-slate-500'
                                    }`}
                                  >
                ...
                {showBulkModal && (
                  <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-fade-in">
                    <div className="bg-white rounded-3xl max-w-2xl w-full border border-slate-200 shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
                      {/* Modal Header */}
                      <div className="p-6 bg-[#E5FD5F] hover:bg-[#d8f244] active:bg-[#F908E0] active:text-white text-[#111111] border-2 border-[#120CD6] text-white flex items-center justify-between">
                        <div className="flex items-center gap-3">
                        ...
                        {!bulkResult ? (
                          <>
                            ...
                            <button
                              ...
                              className="px-5 py-2.5 bg-[#E5FD5F] hover:bg-[#d8f244] active:bg-[#F908E0] active:text-white text-[#111111] border-2 border-[#120CD6] text-white font-black rounded-xl text-xs flex items-center gap-2 shadow-md shadow-sm transition-all cursor-pointer uppercase disabled:opacity-50"
                            >
                              {bulkIsGenerating ? (
                                <>
                                  <RefreshCw className="w-4 h-4 animate-spin" />
                          ...
                          <button
                            ...
                            className="px-5 py-2 bg-[#120CD6] hover:bg-blue-800 active:bg-[#F908E0] text-white font-black rounded-xl text-xs transition-colors cursor-pointer uppercase"
                          >
              ...
              <div className="bg-white rounded-2xl border border-slate-200 p-6 space-y-6">
                <div className="flex items-center justify-between pb-4 border-b border-slate-100">
                  ...
                  <Link
                    href="/"
                    target="_blank"
                    className="px-4 py-2 bg-[#120CD6] hover:bg-blue-800 active:bg-[#F908E0] text-white rounded-xl text-xs font-black flex items-center gap-1.5 cursor-pointer uppercase"
                  >
                ...
                <div className="space-y-4 text-xs">
                  <div className="p-4 bg-[#F5F5F5] rounded-xl border border-slate-200 space-y-2">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-[#111111] font-black bg-indigo-50 text-indigo-700 px-2.5 py-0.5 rounded-full border border-[#120CD6]">
                        Auto-Cleanup Active
                      </span>
                    </div>
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="px-4 py-2.5 bg-[#120CD6] hover:bg-blue-800 active:bg-[#F908E0] text-white rounded-xl text-xs font-black flex items-center gap-1.5 transition-colors cursor-pointer uppercase shadow-sm"
                  >
                    <Plus className="w-4 h-4" />
                              ...
                              <div className="flex items-center justify-center gap-2">
                                <button
                                  ...
                                  className={`px-2 py-0.5 rounded-full text-[10px] font-black cursor-pointer transition-colors ${
                                    tmpl.active ? 'bg-indigo-50 text-indigo-700 font-bold border border-indigo-200 border border-[#120CD6]' : 'bg-slate-100 text-slate-500'
                                  }`}
                                >
        ...
        <footer className="mt-auto border-t-2 border-slate-200 bg-white px-6 py-4 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs font-medium text-slate-600">
          <div className="flex items-center gap-2">
            ...
            <span className="text-slate-500 font-bold">• Nadhisan Studio Cloud OS</span>
          </div>
      ...
      {previewModalImg && (
        ...
        >
          <div className="relative max-w-xl max-h-[90vh] bg-white rounded-2xl p-2 shadow-2xl border-4 border-[#120CD6]" onClick={e => e.stopPropagation()}>
            <button
              onClick={() => setPreviewModalImg(null)}
              className="absolute -top-3 -right-3 w-8 h-8 rounded-full bg-[#120CD6] text-white flex items-center justify-center hover:bg-indigo-700 cursor-pointer shadow-lg font-black"
            >
              <X className="w-4 h-4" />
            </button>
            <img
          ...
          >
            ...
            <div className="pt-2">
              <button
                ...
                className="w-full py-2.5 bg-[#120CD6] hover:bg-blue-800 active:bg-[#F908E0] text-white rounded-xl text-xs font-black transition-colors cursor-pointer uppercase"
              >
                Salin Link Softfile
              </button>
            </div>
            ...
            <form onSubmit={handleSaveTemplate} className="space-y-3 text-xs flex-1 overflow-y-auto pr-1">
              ...
              {templateTabMode === 'xml' ? (
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-[11px] text-[#111111] font-black bg-indigo-50 text-indigo-700 px-2.5 py-0.5 rounded-full border border-[#120CD6]">
              ...
              <div className="pt-3 flex gap-2 shrink-0 border-t border-slate-100">
                ...
                <button
                  type="submit"
                  disabled={actionLoading}
                  className="flex-1 py-2.5 bg-[#120CD6] hover:bg-blue-800 active:bg-[#F908E0] text-white font-black rounded-xl cursor-pointer disabled:opacity-50 uppercase"
                >
          ...
          >
            ...
            <div className="pt-2 flex gap-2">
              <button
                ...
                className="flex-1 py-2.5 bg-[#120CD6] hover:bg-blue-800 active:bg-[#F908E0] text-white shadow-md shadow-sm border-2 border-[#120CD6] font-black rounded-xl text-xs flex items-center justify-center gap-1.5 cursor-pointer uppercase"
              >
